...
class App extends Component {
  state = {
    ...
    videoTracks: new Map(),
    token: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..bwh7KZnPzhjaBzxFPHRYMlOs9TDbKPr53tLEsyAEKdo'
  };
    ...
    return (
      <View style={{ flex: 1 }}>
...

        {
          ...
          <View style={{top:0, height:deviceHeight/2, overflow:'hidden'}}>
            <View style={{ flex: 1 }}>
